...
namespace PeopleHub.Application.DTOs
{
    ...
    {
        [Required(ErrorMessage = "O nome de usuário (CPF) é obrigatório")]
        [Display(Name = "CPF", Description = "Informe o CPF sem pontos ou traços")]
    ...
    public class RegisterDto
    {
        ...
        [StringLength(100, ErrorMessage = "A naturalidade deve ter no máximo 100 caracteres")]
